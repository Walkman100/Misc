...
Partial Class ErrorArk
    ...
    Private Sub InitializeComponent()
        ...
        AddHandler Me.btnSub.Click, AddressOf Me.btnSub_Click
        '
        'btnDivide
        '
        ...
        AddHandler Me.btnDivide.Click, AddressOf Me.btnDivide_Click
        '
        'btnMulti
        '
        ...
        AddHandler Me.btnMulti.Click, AddressOf Me.btnMulti_Click
        '
        'btnExit
        '
